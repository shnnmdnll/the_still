...
<title>Forgot Password — Pahingahan</title>
...
<style>
    * { box-sizing: border-box; }
    ...
    h1 { font-size: 1.4rem; color: #3c6b41; margin: 0 0 8px; text-align: center; }
    p.sub { color: #6b6350; font-size: 0.9rem; text-align: center; margin: 0 0 24px; }
    .input-wrapper { position: relative; margin-bottom: 18px; }
    .input-wrapper i.fa-envelope {
        position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #b5ad94;
    }
    input[type="email"] {
        width: 100%; padding: 12px 14px 12px 40px; border: 1.5px solid #e2ddc9;
        border-radius: 10px; font-size: 0.95rem; font-family: inherit;
    }
    input:focus { outline: none; border-color: #5c8a3a; }
    button[type="submit"] {
        width: 100%; padding: 13px; border: none; border-radius: 10px;
        background: #5c8a3a; color: #fff; font-weight: 700; font-size: 1rem; cursor: pointer;
    }
    ...
    .back-link { display: block; text-align: center; margin-top: 18px; color: #5c8a3a; font-size: 0.85rem; text-decoration: none; font-weight: 600; }
</style>
</head>
<body>
    <div class="card">
        <h1>Forgot your password?</h1>
        <p class="sub">Enter the email you used to register, and we'll send you a link to reset your password.</p>
